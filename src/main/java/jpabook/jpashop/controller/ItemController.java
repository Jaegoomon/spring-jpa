...
public class ItemController {
    ...
    public String updateBook(@PathVariable Long itemId, @ModelAttribute("bookForm") BookForm form) {
        itemService.updateItem(form.getId(), form.getPrice(), form.getStockQuantity());
